...
def plot_comparison(data_dir_1, data_dir_2, filename, title_info):
    ...
    fig.savefig("output/plots/comparison/small_fraction/"+filename+timestr+".eps",format='eps')
...
if __name__ == "__main__":
    ...
    title_info = file_name + ": 31M edges, 1.7M vertices"
    x_min = 0
    x_max = 1.1


    dir_1 = "output/plot_data/comparison_plot_data/"+file_name +".edges/EstTriByRWandWghtedSampling/small_fraction/"
    dir_2 = "output/plot_data/comparison_plot_data/"+file_name+".edges/EstTriByEdgeSampleAndCount/small_fraction/"
    dir_3 = "output/plot_data/comparison_plot_data/"+file_name +".edges/EstTriByRWAndCountPerEdge/small_fraction/"

    dir_4 = "output/plot_data/comparison_plot_data/"+file_name +".edges/EstTriByUniformSampling/small_fraction/"
    #dir_5 = "output/plot_data/comparison_plot_data/"+file_name+".edges/EstTriBySparsification/small_fraction/"
    filename = file_name + "-comparison-"


    plot_comparison(dir_1, dir_4, filename, title_info)
